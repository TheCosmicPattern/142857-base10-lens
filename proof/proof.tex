...
Hamming-family scaffolds $\{2^r-1,\,2^r-1-r,\,r\}$ with the canonical base
...
\begin{definition}[Self-describing]
A Fermat quotient $Q = (b^{n-1}-1)/n$ is \emph{self-describing}
relative to a Hamming-family scaffold when its cyclotomic
factor-blocks are exhausted by scaffold expressions in $\{n,k,r\}$.
\end{definition}
...
For $r \geq 4$: $n = 2^r-1 \geq 3r$, so $n-2r \geq r$, giving
$n(n-2r) \geq 3r \cdot r = 3r^2 > r^2-r+1$. No further solutions.
